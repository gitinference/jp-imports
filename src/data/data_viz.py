...
def gen_pie_chart(time_frame: str, year : str, month : str = None, qrt : str = None, graph_type : str = 'imports'):
    """
    ...
    if time_frame not in ["monthly", "qrt", "yearly"]:
        raise ValueError("El parámetro time_frame debe ser 'monthly', 'qrt' o 'yearly'.")
    ...
    pie_chart = alt.Chart(df_20, title= "Country %s in %d / %d" % (graph_type,7,11)).mark_arc().encode(
